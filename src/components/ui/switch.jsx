  ...
  return (
    <SwitchPrimitive.Root
      ...
      className={cn(
        ...
        // ✅ Track color: green when checked, red when unchecked
        "data-[state=checked]:bg-[#68ba7e] data-[state=unchecked]:bg-[#68ba7e]",
        className
      )}
      {...props}
    >
      <SwitchPrimitive.Thumb
        ...
        className={cn(
          "bg-white pointer-events-none block h-4 w-4 rounded-full ring-0 transition-transform",
